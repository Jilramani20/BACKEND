  ...
  const iceServers = [
    ...
    { 
      ...
      username: '293170f3a4542cdd110037ef941afb8aa6b2bb138699f6fd4947e75b36bdaaea',  
      credential: 'OU2qimnF0oVl1buZsEI6bEq4Ae1XGkOB/EqI7Rf/Hd8=' 
    }
  ];
  ...
  acceptBtn.onclick = async () => {
    ...
    // Add send audio and video to other user
    localStream.getTracks().forEach(track => {
      pc.addTrack(track, localStream);
    });
    
    // get other user video and audio
    pc.ontrack = event => {
      remoteVideo.srcObject = event.streams[0];
    };
